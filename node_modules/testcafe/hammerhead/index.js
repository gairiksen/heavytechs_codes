var Proxy = require("./lib/proxy"), ERR = require("./lib/server_errs"), jsProcessor = require("./shared/js_processor"), CLIENT_ERR = require("./shared/client_errs"), injector = require("./lib/injector"), Charset = require("./lib/charset"), CookieShelf = require("./lib/cookie_shelf");
...
var Hammerhead = module.exports.Hammerhead = function(port, crossDomainPort, hostname, options) {
    ...
    this.injectInPage = function(ctx, chunks, encoding, charset, callback) {
        ...
        injector.injectInPage(chunks, encoding, charset || new Charset(), injectionOptions, callback);
    };
