(function() {
    ...
    var CSS_URL_PROPERTY_VALUE_PATTERN = /(url\s*\(\s*)(?:(')([^\s']*)(')|(")([^\s"]*)(")|([^\s\)]*))(\s*\))|(@import\s+)(?:(')([^\s']*)(')|(")([^\s"]*)("))/g, EVENTS = [ "onblur", "onchange", "onclick", "oncontextmenu", "oncopy", "oncut", "ondblclick", "onerror", "onfocus", "onfocusin", "onfocusout", "onhashchange", "onkeydown", "onkeypress", "onkeyup", "onload", "onmousedown", "onmouseenter", "onmouseleave", "onmousemove", "onmouseout", "onmouseover", "onmouseup", "onmousewheel", "onpaste", "onreset", "onresize", "onscroll", "onselect", "onsubmit", "ontextinput", "onunload", "onwheel", "onpointerdown", "onpoi nterup", "onpointercancel", "onpointermove", "onpointerover", "onpointerout", "onpointerenter", "onpointerleave", "ongotpointercapture", "onlostpointercapture", "onmspointerdown", "onmspointerup", "onmspointercancel", "onmspointermove", "onmspointerover", "onmspointerout", "onmspointerenter", "onmspointerleave", "onmsgotpointercapture", "onmslostpointercapture" ], BOM_REGEX = new RegExp("^(\\xEF\\xBB\\xBF|" + "\\xFE\\xFF|" + "\\xFF\\xFE|" + "\\x00\\x00\\xFE\\xFF|" + "\\xFF\\xFE\\x00\\x00|" + "\\x2B\\x2F\\x76\\x38|" + "\\x2B\\x2F\\x76\\x39|" + "\\x2B\\x2F\\x76\\x2B|" + "\\x2B\\x2F\\x76\\x2F|" + "\\xF7\\x64\\x4C|" + "\\xDD\\x73\\x66\\x73|" + "\\x0E\\xFE\\xFF|" + "\\xFB\\xEE\\x28|" + "\\x84\\x31\\x95\\x33)"), CDATA_REG_EX = /^(\s)*\/\/<!\[CDATA\[([\s\S]*)\/\/\]\]>(\s)*$/, EMPTY_URL_REG_EX = /^(\w+:)?\/\/\:0/, HTML_COMMENT_POSTFIX_REG_EX = /(\/\/[^\n]*|\n\s*)-->[^\n]*([\n\s]*)?$/, HTML_COMMENT_PREFIX_REG_EX = /^(\s)*<!--[^\n]*\n/, HTML_COMMENT_SIMPLE_POSTFIX_REG_EX = /-->\s*$/, HTML_STRING_REG_EX = /^\s*('|")\s*(<[\s\S]+>)\s*('|")\s*$/, JAVASCRIPT_PROTOCOL_REG_EX = /^\s*javascript\s*:/i, SOURCE_MAP_REG_EX = /#\s*sourceMappingURL\s*=\s*[^\s]+(\s|\*\/)/i, URL_ATTRS = [ "href", "src", "action", "manifest", "data" ], URL_ATTR_TAGS = {
        ...
        manifest: [ "html" ],
        data: [ "object" ]
    }, OVERRIDE_DOM_METH_SCRIPT = 'window["' + SharedConst.DOM_SANDBOX_OVERRIDE_DOM_METHOD_NAME + '"]', SCRIPT_HEADER_PREFIX = "/*hammerhead|script-processing-header|start*/", SCRIPT_HEADER_POSTFIX = "/*hammerhead|script-processing-header|end*/", SCRIPT_HEADER = SCRIPT_HEADER_PREFIX + '\r\ntypeof window !== "undefined" && ' + OVERRIDE_DOM_METH_SCRIPT + " && " + OVERRIDE_DOM_METH_SCRIPT + "();\r\n" + JSProcessor.MOCK_ACCESSORS + SCRIPT_HEADER_POSTFIX, SCRIPT_HEADER_REG_EX = new RegExp((SCRIPT_HEADER_PREFIX + "[\\S\\s]+?" + SCRIPT_HEADER_POSTFIX).replace(/\/|\*|\|/g, "\\$&")), HOVER_PSEUDO_CLASS_RE = /\s*:\s*hover(\W)/gi, STYLESHEET_PROCESSING_START_COMMENT = "/*hammerhead|stylesheet|start*/", STYLESHEET_PROCESSING_END_COMMENT = "/*hammerhead|stylesheet|end*/", IS_STYLE_SHEET_PROCESSED_RE = new RegExp("^\\s*" + reEscape(STYLESHEET_PROCESSING_START_COMMENT), "i"), STYLESHEET_PROCESSING_COMMENTS_RE = new RegExp("^\\s*" + reEscape(STYLESHEET_PROCESSING_START_COMMENT) + "\n?|" + "\n?" + reEscape(STYLESHEET_PROCESSING_END_COMMENT) + "\\s*$", "ig"), TARGET_ATTR_TAGS = {
        a: true,
        form: true,
        area: true,
        base: true
    ...
    }, processIntegrityAttr = function(el) {
        if (hasAttr(el, "integrity")) setAttr(el, "integrity", "");
        ...
        if (urlReplacer && pattern.urlAttr) {
            ...
            if ((resourceUrl || resourceUrl === "") && !processedOnServer) {
                if (UrlUtil.isSupportedProtocol(resourceUrl) && !EMPTY_URL_REG_EX.test(resourceUrl)) {
                    ...
                    var charsetAttrValue = isScript && getAttr(el, "charset");
                    var proxyUrl = resourceUrl ? urlReplacer(resourceUrl, resourceType, charsetAttrValue) : "";
                    if (isIframe) {
    ...
    var ELEMENT_PROCESSOR_PATTERNS = [ {
        ...
        elementProcessors: [ processScriptElement, processIntegrityAttr ]
    }, {
    ...
    PageProc.processPage = function($, urlReplacer, crossDomainPort, isIFrame) {
        var $base = $("base"), baseUrl = $base.length ? getAttr($base[0], "href") : "", replacer = function(resourceUrl, resourceType, charsetAttrValue) {
    ...
    PageProc.processStylesheet = function(css, urlReplacer, isStylesheetTable) {
        ...
        css = css.replace(HOVER_PSEUDO_CLASS_RE, "[" + SharedConst.TEST_CAFE_HOVER_PSEUDO_CLASS_ATTR + "]$1");
        css = css.replace(SOURCE_MAP_REG_EX, "$1");
        return prefix + replaceStylsheetUrls(css, urlReplacer) + postfix;
    };
    PageProc.cleanUpStylesheet = function(css, parseProxyUrl, formatUrl) {
        if (typeof css !== "string") return css;
        css = css.replace(new RegExp("\\[" + SharedConst.TEST_CAFE_HOVER_PSEUDO_CLASS_ATTR + "\\](\\W)", "ig"), ":hover$1").replace(STYLESHEET_PROCESSING_COMMENTS_RE, "");
        return replaceStylsheetUrls(css, function(url) {
            var parsedProxyUrl = parseProxyUrl(url);
            return parsedProxyUrl ? formatUrl(parsedProxyUrl.originResourceInfo) : url;
        });
    };
