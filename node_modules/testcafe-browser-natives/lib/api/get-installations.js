    ...
    return _regeneratorRuntime.async(function detectMicrosoftEdge$(context$1$0) {
        while (1) switch (context$1$0.prev = context$1$0.next) {
            case 0:
                ...
                context$1$0.next = 3;
                return _regeneratorRuntime.awrap(_utilsExec.execWinShellUtf8('reg query ' + regKey + ' /s /f MicrosoftEdge /k && echo SUCCESS || echo FAIL'));
    ...
    return _regeneratorRuntime.async(function findMacBrowsers$(context$1$0) {
        while (1) switch (context$1$0.prev = context$1$0.next) {
            ...
            case 3:
                stdout = context$1$0.sent;
                context$1$0.next = 6;
                return _regeneratorRuntime.awrap(_promise2.default.all(stdout.split('\n').filter(function (fileName) {
                    return !!fileName;
    ...
    return _regeneratorRuntime.async(function findLinuxBrowsers$(context$1$0) {
        while (1) switch (context$1$0.prev = context$1$0.next) {
            case 0:
                installations = {};
                context$1$0.next = 3;
                return _regeneratorRuntime.awrap(_utilsExec.exec('update-alternatives --list x-www-browser'));
